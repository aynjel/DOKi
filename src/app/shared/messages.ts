...
export class Messages {
   ...
   * Browser
   */
  public BROWSER_ENABLE_JAVASCRIPT: string =
    'Please enable JavaScript to continue using this application.';

  /**
   * Confirmation
   */
  public CONFIRMATION_DELETE_RECORD: string =
  ...
  public INVALID_USER_NAME_OR_PASSWORD: string =
  ...
  public ERROR_RETRIEVING_ADMITTED_PATIENTS: string =
    'Sorry Dok. We cannot retrieve the list of your admitted patients at this time. Please try again.';
