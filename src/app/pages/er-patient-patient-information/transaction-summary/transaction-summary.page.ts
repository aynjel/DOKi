...
export class TransactionSummaryPage implements OnInit {
  ...
  ngOnInit() {
    ...
    //this.postData = JSON.parse(atob(localStorage.getItem('postData'))) as ErPatientData;
  ...
  postSummary() {
    ...
    console.log('this.data[0].payvenue', this.data[0].payvenue);
    if (
      ...
      buttons: [
        {
          ...
          handler: () => {
            ...
            //this.nav.navigateBack('menu/er-patients' );
          },
        },
      ],
