...
export class ChhAppProfessionalFeeSummaryPage implements OnInit {
  ...
  isPatientSeen: any = 'o';
  InsurancePF: number;
  InsuranceShowVat = false;
  InsuranceVat = true;
  PhilhealthShowVat = false;
  PersonalPhilhealthShowVat = false;
  PhilhealthVat = true;
  PersonalPhilhealthVat = true;
  PhilhealthPF: number;
  PersonalPhilhealthPF: number;
  PhilhealthShowValue = true;
  IsPhilhealthOnly = true;
  progressStatus: any = 0.75;
  nxtBtn = false;
  summary: any = '';
  txtInsurancePF = true;
  txtInsuranceVAT = true;
  txtPhilHealthPF = true;
  txtPhilHealthVAT = true;
  txtPersonalPhilHealthVAT = true;
  headerMethod: any;
  ...
  ngOnInit() {
    ...
    this.routerLinkBack1 = '/menu/er-patients/' + this.id;
    this.routerLinkBack2 = '/menu/er-patients/' + this.id + '/professional-fee';
    this.routerLinkBack3 =
      '/menu/er-patients/' + this.id + '/professional-fee/' + this.method1;
  ...
  ionViewWillEnter() {
    ...
    const logindata = <LoginResponseModelv3>this.authService.userData$.getValue();
