...
export class ChhAppProfessionalFeePage implements OnInit {
  ...
  ngOnInit() {
    ...
    const getValue = this.activatedRoute.snapshot.paramMap.get('state');

    this.initiateSession();
    this.routerLinkBack = '/menu/er-patients/';

    this.patient_id = this.activatedRoute.snapshot.params.id;
    this.routerLinkBack = '/menu/er-patients/' + this.patient_id + '/';
  ...
  areyouaninsurancecoordinator = true;
