...
*/
  ...
  loginV3(data:any){
    ...
    const url = "http://10.130.21.217:5002/api/v3/User/Token";
  ...
  getUserSettingsV3(){
   ...
   const url = 'http://10.130.21.217:5002/api/v3/UserSettings';
  ...
  getAppSettingsV3(){
    ...
    const options = { headers: headers, withCredintials: false };
   //const url = environment.apiRouterUrl + 'v2/AppSetting/User/'+Consta.appCode+'/'+data1+'/'+Consta.mode;
   const url = '  http://10.130.21.217:5002/api/v3/AppSettings';
    return this.http.get(url, options);
  }
  ...
  getInPatientV3() {
    ...
    const options = { headers: headers, withCredintials: false };
   //const url = environment.apiRouterUrl + 'v2/AppSetting/User/'+Consta.appCode+'/'+data1+'/'+Consta.mode;
    const url = "http://10.130.21.217:5002/api/v3/InPatients";
    return this.http.get(url, options);
  }
  getCoDoctorsV3(postData1: any) {
    ...
    const options = { headers: headers, withCredintials: false };
   // const url = environment.apiRouterUrl + "v2/Inpatients/CoDoctors";
    const url = "http://10.130.21.217:5002/api/v3/InPatients/CoDoctors";
    return this.http.post(url,  postData1, options);
  }
  getAdmittingDiagnosisV3(postData1: any) {
    ...
    const options = { headers: headers, withCredintials: false };
    //const url = environment.apiRouterUrl + "v2/Inpatients/AdmittingDiagnosis";
    const url = "http://10.130.21.217:5002/api/v3/InPatients/AdmittingDiagnosis";
    return this.http.post(url,  postData1, options);
  }
  getFinalDiagnosisV3(postData1: any) {
    ...
    const options = { headers: headers, withCredintials: false };
    //const url = environment.apiRouterUrl + "v2/Inpatients/FinalDiagnosis";
    const url = "http://10.130.21.217:5002/api/v3/InPatients/FinalDiagnosis";
    return this.http.post(url,  postData1, options);
  }
